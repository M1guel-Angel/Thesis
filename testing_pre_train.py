...
if __name__ == '__main__':
	...
	if len(h_train_acc):
		...
		print("Accuracy max en el entrenamiento: " + str(max(h_train_acc)))
		print("Loss max en el entrenamiento: " + str(max(h_train_loss)))
		print("Accuracy max en la validacion: " + str(max(h_test_acc)))
		print("Loss max en la validacion: " + str(max(h_test_loss)))
		print("Demora maxima: " + str(max(h_delay)))

		print("Accuracy min en el entrenamiento: " + str(min(h_train_acc)))
		print("Loss min en el entrenamiento: " + str(min(h_train_loss)))
		print("Accuracy min en la validacion: " + str(min(h_test_acc)))
		print("Loss min en la validacion: " + str(min(h_test_loss)))
		print("Demora minima: " + str(min(h_delay)))
